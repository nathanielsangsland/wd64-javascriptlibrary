...
//We are capable of utillizing bracket notation as well.
console.log('Episode:', netflix.season1.seasonInfo.episodeInfo[3].episodeName);

//? JSON Objects
/*
    - JSON: JavaScripte Object Notation
...
console.log(Object.keys(spaceJam.toonSquad.tDevil)); // String of the index nymbers of that string value
...
/*
    - onject bracket notation can also aloow us to finda value in an object.
    ...
    -this works becuase ALL keys in an object are STRINGS.
*/
...
// We are accessing the keys within our object by a specific name within our square bracket.  THe key name that is passed beeds to be wrapped quotes as all keys in an object are strings.
...
console.log(baking[garden['vegetable']]); // here we are saying the same thing as we did above, except we are passing information form our object. garden['vegeetable'] is the same as 'zucchini' up above.
