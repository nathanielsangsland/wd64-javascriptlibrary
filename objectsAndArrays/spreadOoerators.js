...
const copiedNamesDiff = ['Adam', 'Janye', nameOne, nameTwo];
console.log(copiedNamesDiff);

/*
    Since the spread operator is pulling out all items of an array, we need to make sure we use the spread operator within a new array.  This is so the values that were pulled out get place into our new array.
...
console.log(Math.min(...prices));  // Spread Op pulls elements out of array to allow the min method to work.
...
copiedPerson[0].location = 'starship';
...
/*
    ...
    - 3 Data Types that are passed by reference: Array, Functions, and Objects
        ...
        * pretend datatype: address - denoted by < >
        ...
        -How are code would look in memory:
 ...
 /*
 * *********
 ! .... & AVOIDING CHANGING BOTH THE ORGINAL & COPIED ARRAY
 * *********
 */
 ...
 console.log('After Altering: ', comics, compiedComics);
